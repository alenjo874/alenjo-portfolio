...
function Resume({ scrollShowAnimation }) {
  const experienceArray = [
    ...
    },
    {
      ...
      details: [
        "Evaluated ideal contract pricing and coordinated with sales team to maximize company profit margins",
        "Achieved the highest total volume of contract renewals within the team attributed to consistent quarterly performance",
        "Analyzed internal data using Excel to ensure contracts comply with company goals and standards",
        "Conducted pricing support review that captured an average of over $5000 monthly missing rebates",
      ],
      location: "Jersey City, NJ",
    ...
    },
    {
      ...
      details: [
        ...
        "Analyzed and imputed all aspects of account/assets information to ensure conformance with company policies and a high level of customer satisfaction",
      ],
    ...
    },
    {
      ...
      details: [
        ...
        "Performed market research analysis on industry trends and competitive landscapes leading to an increase in customer base ",
        "Collaborated on special projects for sales and marketing development to generate leads",
      ],
